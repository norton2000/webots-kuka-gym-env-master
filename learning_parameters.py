...
dmp_stime = 200 #100  # number of simulation's timesteps  Default: 100
...
bbo_sigma_arm_scale = 0.03 #0.001 #0.007 #0.001
...
bbo_sigma_decay_amp = 0.3 #0.04 #0.005 #0.007 #0.01 #0.015  # variable sample variance         #Default 0.0
bbo_sigma_decay_start = 0                                       #Default 0
bbo_sigma_decay_period = 0.2#0.03 #0.025 #0.07 #0.04 #0.01 #0.015 #0.025                                  #Default 0.01
...
dist_dev_beta = 0.1 #0.6   #0.1                                             #Default 0.1
dist_dev_gamma = 0.012 #0.023 #0.012                                          #Default 0.012
alpha = 1e7 #0.01  #1e4#1e5#1e5 #6e5 #1e4 #1e4 # floor distance                               #Default: 1e4
beta = 0.8 #0.02  #0.01#0.01 #0.1 #1 #1 #10     # finger_distance                              #Default: 1
gamma = 1e4 #0.02#1#1e2 #1e2 #5e6 #1e8 #1e5 # touch * finger_distance                      #Default: 1e8
