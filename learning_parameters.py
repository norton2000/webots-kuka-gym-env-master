...
dmp_stime = 40 #35 #200 #100  # number of simulation's timesteps  Default: 100
...
bbo_sigma_arm_scale = 0.0017 #0.001 #0.007 #0.001
...
gamma = 1.5 #1.1 #0.02#1#1e2 #1e2 #5e6 #1e8 #1e5 # touch * finger_distance                      #Default: 1e8
